...
namespace Ezpz\Common\Payment\Lib;
...
class CreditCardValidator
{
    ...
    function validate($cardnumber, $cardname, &$errornumber, &$errortext)
    {
        ...
        $prefix = explode(',', $this->cards[$cardType]['prefixes']);
        ...
        $LengthValid = false;
        $lengths = explode(',', $this->cards[$cardType]['length']);
